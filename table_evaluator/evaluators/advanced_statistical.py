...
class AdvancedStatisticalEvaluator:
    ...
    def comprehensive_evaluation(
        ...
        try:
            results['wasserstein'] = self.wasserstein_evaluation(real, fake, numerical_columns, **wasserstein_config)
        except Exception as e:
        ...
        # MMD analysis
        try:
            results['mmd'] = self.mmd_evaluation(real, fake, numerical_columns, **mmd_config)
        except Exception as e:
        ...
        # Combined analysis
        try:
            results['combined_metrics'] = self._combine_metrics(results['wasserstein'], results['mmd'])

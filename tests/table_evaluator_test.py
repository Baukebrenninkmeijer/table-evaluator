...
def test_evaluate_method():
    ...
    expected_keys = ["Overview Results", "\nRegressor MSE-scores", "Privacy Results", "Jensen-Shannon distance", "Kolmogorov-Smirnov statistic"]
...
def test_evaluate_method_class():
    ...
    assert isinstance(results, dict)
    expected_keys = ["Overview Results", "Classifier F1-scores and their Jaccard similarities:", "Privacy Results", "Jensen-Shannon distance", "Kolmogorov-Smirnov statistic"]
    for key in expected_keys:
        assert key in results